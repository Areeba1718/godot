...
#ifdef USE_LIGHTMAP
		uint multimesh_count = floatBitsToUint(instances.data[draw_call.instance_index].lightmap_uv_scale.x);
		uint lightmap_offset = multimesh_count * stride + gl_InstanceIndex;
